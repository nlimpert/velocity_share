...
protected:
  void robotVelCallback(const velocity_share_msgs::RobotVelInfoStamped& robot_vel_info);
  ros::Subscriber robot_vel_sub_;
  std::map<std::string, velocity_share_msgs::RobotVelInfoStamped> robot_vel_infos_;
